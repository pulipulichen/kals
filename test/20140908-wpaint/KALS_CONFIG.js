...
DEFAULT_KALS_CONFIG = {
    ...
    ckeditor_config: {
        ...
        extraPlugins: 'kals_maximize,youtube,recordmp3js,wpaint',
        ...
        toolbar: [
			...
			//最小化的時候顯示的工具列
            ['Maximize','Source','-','Bold', 'Italic', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink', 'Image','Youtube', 'recordmp3js', "wpaint"]	
        ],
        height: '50px',
        //width: '261px',
