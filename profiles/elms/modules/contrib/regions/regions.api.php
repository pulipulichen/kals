...
/**
 * Hook allowing other modules to alter the region array before the each element
 ...
 *     returned by theme_block(). @see hook_regions_blocks_alter()
 *   - end: a closing DIV.
...
/**
 * Hook allowing other modules to alter any newly defined regions blocks array
 * before the each block object is rendered by theme_block().
 *
 * @param array $blocks
