...
//###### Config ######
$absPthToSlf = 'http://localhost/kals-drupal/drupal/sites/all/libraries/tinymce/uploadimages/tinyupload.php'; //The Absolute path (from the clients POV) to this file.
$absPthToDst = 'http://localhost/kals-drupal/drupal/sites/all/libraries/tinymce/uploadimages/'; //The Absolute path (from the clients POV) to the destination folder.
$absPthToDstSvr = 'localhost/kals-drupal/drupal/sites/all/libraries/tinymce/uploadimages/'; //The Absolute path (from the servers POV) to the destination folder. You will need to set permissions for this dir 0777 worked ok for me.
