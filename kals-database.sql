...
--
-- Name: annotation2read; Type: TABLE; Schema: public; Owner: kals; Tablespace: 
--

CREATE TABLE annotation2read (
    annotation2read_id integer NOT NULL,
    annotation_id integer NOT NULL,
    user_id integer NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    canceled boolean DEFAULT false NOT NULL,
...
ALTER TABLE public.annotation2read OWNER TO kals;

--
-- Name: annotation2read_annotation2read_id_seq; Type: SEQUENCE; Schema: public; Owner: kals
--

CREATE SEQUENCE annotation2read_annotation2read_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.annotation2read_annotation2read_id_seq OWNER TO kals;

--
-- Name: annotation2read_count; Type: VIEW; Schema: public; Owner: kals
--

CREATE VIEW annotation2read_count AS
    SELECT annotation.annotation_id, count(annotation2read.user_id) AS read_count FROM (annotation LEFT JOIN annotation2read ON ((((annotation.annotation_id = annotation2read.annotation_id) AND (annotation2read.canceled = false)) AND (annotation.user_id <> annotation2read.user_id)))) GROUP BY annotation.annotation_id;


ALTER TABLE public.annotation2read_count OWNER TO kals;
