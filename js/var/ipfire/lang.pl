...
# you should create a file with <PREFIX>.<LANG>.pl into /var/ipfire/addon-lang dir
...
#		You can find a detailed list of possible mnemonic's in the file /var/ipfire/langs/list
...
# --------- CODE END---------
#
# After you have copied all your files to /var/ipfire/add-lang you have to run the
# script compilation:
