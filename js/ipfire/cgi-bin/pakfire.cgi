...
my $poundfile = "/etc/init.d/pound";
if (-e $poundfile) {
&Header::openbox("100%", "center", "$Lang::tr{'pound'}");
print <<END;
<div style="text-align:left"><a href="/pound_edit.php" target="pound_edit">pound.cfg editor</a></div>
END
&Header::closebox();
}
