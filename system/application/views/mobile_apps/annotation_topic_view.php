...
<div data-role="header" data-position="fixed">
    ...
    if (isset($user) && is_object($user)) {
        ?>
        <span class="ui-btn-right ui-btn ui-btn-b ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right">
            <?php echo $user->get_id(); ?>
        </span>
        <?php
    }
    else {
        ?>
        <a href="<?php echo base_url().'mobile/mobile_user_login'; ?>" 
           class="ui-btn-right ui-btn ui-btn-b ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right">
            <?php echo $lang->line('mobile.hello_guest');?></a>
        <?php
    }
