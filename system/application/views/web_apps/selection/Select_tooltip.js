 ...
 * @type {JSON}
 */
Select_tooltip.prototype._config = null;
...
Select_tooltip.prototype._$get_config = function () {
    ...
    _config['onBeforeShow'] = function (_event) {
        _this.on_before_show(this, _event);
    };    //onBeforeShow: function () {
    
    _config['onBeforeHide'] = function (_event) {
        _this.on_before_hide(this, _event);
 ...
 * 設定顯示前的動作
 */
Select_tooltip.prototype.on_before_show = function(_this, _event){
	
    //if ($.is_null(_this))
    //var _this = this;
        
    if (this.enable_select === false) {
        return;
    }
    ...
    if ($(".ff1").length > 0) {
        ...
        /*
        var _pos = _trigger.offset();
        _trigger.css("border", "1px solid red");
        $.test_msg("Select_tooltip", [_trigger.text(), _pos.top, _pos.left, _trigger.attr("offsetWidth"), _trigger.width(), _trigger.outerWidth(false), _trigger.css("width")]);
        var _tip_pos = _tip.offset();
        $.test_msg("tooltiop", [_tip_left, _tip_pos.top, _tip_pos.left, _tip.width()]);
        //return;
        */
    }
    ...
    //var _config = Tooltip_modal.prototype._$get_config.call(this, '#' + this.tooltip_id + ':first');
    var _onbeforeshow = $.get_parameter( this._config, 'onBeforeShow' );
 ...
 * 設定隱藏前的動作
 */
Select_tooltip.prototype.on_before_hide = function (_this, _event) {
	...
	//var _config = Tooltip_modal.prototype._$get_config.call(this, '#' + this.tooltip_id + ':first');
    var _onbeforehide = $.get_parameter( this._config, 'onBeforeHide' );
