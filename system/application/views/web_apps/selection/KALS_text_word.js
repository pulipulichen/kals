...
/**
 * @memberOf {KALS_text_word}
 * @extends {KALS_user_interface}
 * @constructor
 */
function KALS_text_word() {
 ...
 * @memberOf {KALS_text_word}
 */
KALS_text_word.prototype = new KALS_user_interface();
 ...
 */
KALS_text_wordprototype.word_count = 0;
 ...
 */
KALS_text_word.prototype.word_classname = 'kals-word';
 ...
 */
KALS_text_word.prototype.word_id_prefix = 'kals_word_';


KALS_text_word.prototype._span_classname = 'span';
 ...
 */
KALS_text_word.prototype.get_word_by_index = function(_index) {
 ...
 */
KALS_text_word.prototype.get_word_id = function (_word) {
    if ($.is_object(_word)) {
        if ($.is_jquery(_word)) {
            _word = _word.attr('id');
        }
 ...
 * @TODO 20140102 尚未更新相關使用的程式碼 this.get_word_id
 */
KALS_text_word.prototype.is_word_next_english = function (_word) {
 ...
 * @TODO 20140102 尚未更新相關使用的程式碼 this.get_word_id
 */
KALS_text_word.prototype.is_word_next_span = function (_word) {
...
KALS_text_word.prototype.get_word_next_span = function (_word) {
    var _next = _word.next();
 ...
 * @TODO 20140102 尚未更新相關使用的程式碼 this.get_word_id
 */
KALS_text_word.prototype.get_words_by_scope_coll = function (_scope_coll) {
 ...
 * @type {jQuery}
 */
KALS_text_word.prototype.create_span_word = function(_text) {
...
/* End of file KALS_text_word */
/* Location: ./system/application/views/web_apps/KALS_text_word.js */