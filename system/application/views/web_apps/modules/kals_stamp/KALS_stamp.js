...
KALS_stamp.prototype.check_qualification_liked_users_count = function(_user, _config) {
    ...
    //KALS_util.notify("NO5.liked_users_count ="+ _config.count + " user = " + _liked_users_count);
    //$.test_mag("NO5.liked_users_count BY user = ", _liked_users_count);
    if ( _liked_users_count < _config.count ){
       // 不合格
       _stamp_qualified = false;
        //KALS_util.notify("第5項liked_users_count未達成"+ _config.count + " user = " + _liked_users_count);
       //break;
    }
    else { // 合格
       _stamp_qualified = true;
        //KALS_util.notify("第5項liked_users_count已達成"+ _config.count + " user = " + _liked_users_count);
    }
