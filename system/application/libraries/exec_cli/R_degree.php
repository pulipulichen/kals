...
//        $file_degree = "D:/tmp/output".$date.".csv";
//        
//        $query = $this->db->query('select * from stuin');
//        $row = $query->row_array();
//        $file_degree = "sna".$date.".csv";
//
...
//         fclose($fp);
//            
//        exec("C:/R/bin/Rscript.exe D:/degree_rscript.r $file_degree", $b_output, $return_var);
    
        exec("C:/R/bin/Rscript.exe D:/degree_rscript.r $file_degree", $d_output, $return_var);
