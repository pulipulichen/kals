...
class Minify_YUICompressor {
    ...
    {
        self::_prepare();
        if (! ($tmpFile = tempnam(sys_get_temp_dir(), 'yuic_'))) {
    ...
    private static function _getCmd($userOptions, $type, $tmpFile)
    {
        ...
        $cmd = self::$javaExecutable . ' -jar ' . escapeshellarg(dirname(__FILE__) . DIRECTORY_SEPARATOR . self::$jarFile)
             . " --type {$type}"
    ...
    {
        if (! is_file(dirname(__FILE__) . DIRECTORY_SEPARATOR . self::$jarFile)
