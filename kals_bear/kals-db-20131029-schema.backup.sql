...
CREATE VIEW webpage2annotation AS
    SELECT DISTINCT scope.webpage_id, annotation.annotation_id FROM ((annotation JOIN annotation2scope ON ((annotation.annotation_id = annotation2scope.annotation_id))) JOIN scope ON ((annotation2scope.scope_id = scope.scope_id))) ORDER BY scope.webpage_id, annotation.annotation_id;


ALTER TABLE public.webpage2annotation OWNER TO kals;

--
-- Name: rank; Type: VIEW; Schema: public; Owner: kals
--

CREATE VIEW rank AS
    SELECT webpage2annotation.webpage_id, "user".user_id, "user".name AS user_name, avg(top.t_score) AS t_score_avg FROM webpage2annotation, top, "user" WHERE ((top.user_id = "user".user_id) AND (webpage2annotation.annotation_id = top.topic_id)) GROUP BY "user".user_id, webpage2annotation.webpage_id, "user".name HAVING (count(top.t_score) >= 2) ORDER BY avg(top.t_score) DESC;


ALTER TABLE public.rank OWNER TO kals;
...
ALTER TABLE anchor_text ALTER COLUMN anchor_text_id SET DEFAULT nextval('anchor_text_anchor_text_id_seq'::regclass);
...
ALTER TABLE annotation ALTER COLUMN annotation_id SET DEFAULT nextval('annotation_annotation_id_seq'::regclass);
...
ALTER TABLE annotation2like ALTER COLUMN annotation2like_id SET DEFAULT nextval('annotation2like_annotation2like_id_seq'::regclass);
...
ALTER TABLE annotation2respond ALTER COLUMN annotation2respond_id SET DEFAULT nextval('annotation2respond_annotation2respond_id_seq'::regclass);
...
ALTER TABLE annotation2scope ALTER COLUMN annotation2scope_id SET DEFAULT nextval('annotation2scope_annotation2scope_id_seq'::regclass);
...
ALTER TABLE "group" ALTER COLUMN group_id SET DEFAULT nextval('group_group_id_seq'::regclass);
...
ALTER TABLE group2actor ALTER COLUMN group2actor_id SET DEFAULT nextval('group2actor_group2actor_id_seq'::regclass);
...
ALTER TABLE langvar ALTER COLUMN langvar_id SET DEFAULT nextval('langvar_langvar_id_seq'::regclass);
...
ALTER TABLE log ALTER COLUMN log_id SET DEFAULT nextval('log_log_id_seq'::regclass);
...
ALTER TABLE policy ALTER COLUMN policy_id SET DEFAULT nextval('policy_policy_id_seq'::regclass);
...
ALTER TABLE policy2actor ALTER COLUMN policy2actor_id SET DEFAULT nextval('policy2actor_policy2actor_id_seq'::regclass);
...
ALTER TABLE scope ALTER COLUMN scope_id SET DEFAULT nextval('scope_scope_id_seq'::regclass);
...
ALTER TABLE score ALTER COLUMN score_id SET DEFAULT nextval('score_score_id_seq'::regclass);
...
ALTER TABLE webpage ALTER COLUMN webpage_id SET DEFAULT nextval('webpage_webpage_id_seq'::regclass);
