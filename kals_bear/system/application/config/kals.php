...
$config['output.cache.enable'] = true; //true;
$config['output.cache.expiration'] = 60;  //快取的單位是「分鐘」，目前設定為快取1週
$config['output.package.enable'] = false; //true;
...
$config['ckip.username'] = 'bear';
$config['ckip.password'] = 'nccubear';
 ...
 * 六項因素的權重
 */
$config['langvar.consensus.weight'] = 0.305;    //實際上四捨五入是0.252，但因為要加總為1，所以將最後配分0.001給它
$config['langvar.like.weight'] = 0.241;
$config['langvar.type.weight'] = 0.236;
$config['langvar.speech.weight'] = 0.103;
$config['langvar.length.weight'] = 0.115;
