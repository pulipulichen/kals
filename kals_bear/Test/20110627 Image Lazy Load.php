...
class Example extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testMyTestCase()
  {
    ...
    for ($second = 0; ; $second++) {
        ...
        try {
            if ($this->isElementPresent("css=img[title=\"2011-06-25_233326 設計 網頁元素\"][src=\"http://lh4.ggpht.com/-a6cwLWbFve8/Tgg8J05sfPI/AAAAAAAAIYE/lU7sCSU6L0o/Image.png?imgmax=800\"]")) break;
        } catch (Exception $e) {}
        sleep(1);
    }
    /*
